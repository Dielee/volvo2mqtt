...
| `CONF_volvoData`          | `json`    | `vccapikey`                           | **required** | VCCAPIKEY linked with your volvo developer account. Get your Vccapi key from [here](https://developer.volvocars.com/account/)
| `CONF_volvoData`          | `json`    | `backupvccapikey`                     | optional     | Backup VCCAPIKEY if your quota from the first API key is depleted. Get your Vccapi key from [here](https://developer.volvocars.com/account/)
